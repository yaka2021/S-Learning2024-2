 ...
 function DisplayLogoutCofirmModal(){
    ...
    <div class="confirm_layer confirm_js-modal">
          ...
          <div class="confirm_modal__inner">
            <div class="confirm_modal__contents">
              <div class="confirm_modal__content">
                <p>ログアウトしますか？</p>
                <button class="confirm_modal-button confirm_js-close-button">キャンセル</button>
                <button id="ModalLogoutBtn" class="confirm_modal-button">ログアウト</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <script>
        ...
        const confirm_modalButton = document.querySelector(".confirm_js-modal-button");
