...
(function () {
  ...
  fetchFile("pm", "/2024/_src/pointManager.js");
  fetchFile("main", "./main.js");

  function preparePractice() {
    window.onload = function () {};
    document.body.appendChild(
      makeAudioTag("audioGet", "maodama_magical21.mp3")
    );
    document.body.appendChild(
      makeAudioTag("audioAlready", "maodama_magical27.mp3")
    );
  }
  function makeAudioTag(id, name) {
    const audio = document.createElement("audio");
    audio.id = id;
    audio.src = "/2024/_audio/" + name;
    audio.hidden = true;
    audio.loop = false;
    audio.volume = 0.3;
    audio.load();
